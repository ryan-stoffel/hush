...
final class LLMCleanupTests: XCTestCase {
    ...
    func testStepPassesContextAndLevel() async throws {
        ...
        let context = CleanupContext(language: "en", dictionary: ["Hush"])
        ...
        XCTAssertEqual(cleaner.requests.first?.dictionaryTerms, ["Hush"])
    }
